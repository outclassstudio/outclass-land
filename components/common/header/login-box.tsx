  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <Link
        ...
        p-1 hover:bg-neutral-100 dark:hover:bg-neutral-800 rounded-md flex gap-3 items-center"
      >
        <QuestionMarkCircleIcon className="size-8 text-neutral-600 dark:text-neutral-400" />
        계정 만들기
      </Link>
    </div>
  );
