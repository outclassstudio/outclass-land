  ...
  return (
    <div className="w-screen bg-[#fffae0] flex justify-center">
      <div className="flex flex-col px-7 py-32 w-full sm:w-[768px]">
        <h1
          className="text-3xl text-neutral-800 md:text-4xl font-bold mb-8 drop-shadow-sm
        ...
        <p className="font-semibold flex flex-col text-lg sm:text-xl text-neutral-700">
          이런 문제를 경험하고 있다면 아웃클래스를 찾을 때입니다.
        </p>
      </div>
    </div>
  );
