...
export default function ThemeToggleButton() {
  const { setLightMode, setDarkMode, isDark } = useThemeStore();
  ...
  return (
    <div className="flex flex-col justify-center items-center">
      <label
        className="flex items-center justify-center cursor-pointer w-8 h-8 bg-slate-100 hover:bg-slate-200 
        dark:bg-slate-700 dark:hover:bg-slate-600/80 rounded-full transition"
