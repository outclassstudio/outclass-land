...
import { getMorePosts } from "@/app/post/actions";
import { InitialPosts } from "@/app/post/(main)/page";
...
export default function PostList({ initialPosts }: PostsListProps) {
  ...
  return (
    <div className="w-screen md:w-[768px] flex flex-col items-center min-h-[calc(100vh-300px)]">
      {posts.map((post) => (
